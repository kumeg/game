...
export function getRoom() {
  ...
  [// room1（位置修正済）
     // room1（位置修正済）
      { id: 0, x: 200, y: 255, w: 75,  h: 75,  color: "rgba(255,0,0,0.2)", type: 1 },
      { id: 1, x: 275, y: 245, w: 165,  h: 95,  color: "rgba(255,0,0,0.2)", type: 2 },
      { id: 2, x: 305, y: 340, w: 125,  h: 115,  color: "rgba(255,0,0,0.2)", type: 3 },
      /* { id: 3, x: 440, y: 225, w: 165,  h: 155,  color: "rgba(155,0,0,0.2)", type: 4 }, */
      { id: 4, x: 445, y: 245, w: 185,  h: 85,  color: "rgba(255,100,0,0.2)", type: 5 },
      { id: 5, x: 468, y: 95, w: 135,  h: 145,  color: "rgba(255,0,0,0.2)", type: 6 },
      { id: 6, x: 450, y: 330, w: 125,  h: 95,  color: "rgba(255,0,240,0.2)", type: 7 }
  ],
  [
      // room1（位置修正済）
...
export function getBtns() {        
         ...
         return [
          ...
          { number: 1, classname: "Btn1", go: () => move(0,1), typeIndex: 0, display: "→"},
          { number: 2, classname: "Btn1", go: () =>move(0, 0), typeIndex: 1, display: "←"},
          { number: 3, classname: "Btn3", go: () =>move(0, 2), typeIndex: 1, display: "↓"},
          { number: 4, classname: "Btn3", go: () =>move(0, 1), typeIndex: 2, display: "↑"},
          { number: 5, classname: "Btn4", go: () =>move(0, 3), typeIndex: 1, display: "→"},
          { number: 6, classname: "Btn4", go: () =>move(0, 1), typeIndex: 3, display: "←"},
         /*  { number: 7, classname: "Btn5", go: () =>move(0, 4), typeIndex: 3, display: "↑"}, */
         /*  { number: 6, classname: "Btn5", go: () =>move(0, 3), typeIndex: 3, display: "↓"}, */
          { number: 7, classname: "Btn6", go: () =>move(0, 4), typeIndex: 3, display: "↑a"},
          { number: 7, classname: "Btn6", go: () =>move(0, 3), typeIndex: 4, display: "↓b"},
          { number: 7, classname: "Btn7", go: () =>move(0, 5), typeIndex: 3, display: "↓c"},
          { number: 7, classname: "Btn7", go: () =>move(0, 3), typeIndex: 5, display: "↑d"}
        ],
        [
          /* 赤 */
